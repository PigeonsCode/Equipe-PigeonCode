...
| :--: | :--------: | ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :--------: | :----: | :----: |
|  1   |    Alta    | Planejamento das informações mostradas ao administrador.            | Estabelecer como as informações coletadas pelo banco de dados serão utilizadas para mostrar um relatório eficaz ao administrador. (Meta)                                                                                                   |     5      |   3    |        |
|  2   |    Alta    | Pesquisar a biblioteca para gráficos.                               | Reunir quais são as possibilidades de bibliotecas disponíveis e definir qual será utilizada. (Meta)                                                                                                                                        |     2      |   3    |        |
|  3   |    Alta    | Tratamento de dados para os gráficos.                               | Tratar os dados coletados no banco de dados para serem utilizados em conjunto com a biblioteca de gráficos. (Meta)                                                                                                                         |     8      |   3    |        |
|  4   |    Alta    | Refatoração de código da sidebar de navegação.                      | Refatorar o código da barra de navegação da área de treinamentos para utilizá-lo dentro da área de acesso restrito. (Meta)                                                                                                                 |     13     |   3    |        |
|  5   |    Alta    | Página de visualização dos relatórios.                              | Exibir os gráficos e informações coletadas nos formulários para o administrador. Deve conter uma área para informações gerais que indiquem a qualidade daquele projeto como um todo e sessões específicas para cada processo SCRUM. (Meta) |     8      |   2    |        |
|  6   |    Alta    | Criar projetos na área de administrador.                            | Criar um botão para criação dos projetos do administrador. Deve pedir apenas por nome e descrição e armazenar no bando de dados. (Meta)                                                                                                    |     8      |   3    |        |
|  7   |   Média    | Filtrar as respostas dos formulários para suas respectivas sessões. | Cada resposta obtida nos formulários enviados deve ser mostrada no projeto em específico para o qual ele foi preenchido. (Meta)                                                                                                            |     8      |   3    |        |
|  8   |   Média    | Implementar a deleção dos projetos.                                 | Criar um botão para exclusão de projetos previamente criados. Deve pedir por confirmação a fim de que o usuário tenha certeza sobre a deleção antes de finalizá-la. (Meta)                                                                 |     5      |   3    |        |
|  9   |   Baixa    | Cálculo da qualidade.                                               | Criar a funcionalidade que define a qualidade dos processos a partir dos dados coletados no banco de dados. Estabelecer quais serão os “níveis” diferentes e o intervalo de notas que eles compreendem. (Meta)                             |     3      |   3    |        |
